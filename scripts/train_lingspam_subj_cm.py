...
if __name__ == '__main__':
	...
	model.save('ls_subj_CM.h5')
	model.save_weights('ls_subj_weights_CM.hdf5')
	savePickle(history.losses,'ls_subj_CM_history.losses')
	savePickle(history.acc,'ls_subj_CM_history.acc')
